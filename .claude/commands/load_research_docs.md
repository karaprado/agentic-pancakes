...
1. Read the research/README.md file
2. See if any research/<some-filename>.md file already exists
...
3. For each url in research/README.md that was not skipped, Use the Task tool in parallel and use follow the `scrape_loop_prompt` as the exact prompt for each Task
   <scrape_loop_prompt>
