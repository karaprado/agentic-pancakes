...
async function analyzeContent(contentPath, options) {
    // Read content
...
async function validateGeo(contentPath) {
    const content = await fs.readFile(contentPath, 'utf-8');
...
function formatAsText(result, filePath) {
    const lines = [];
...
function formatAsHTML(result, filePath) {
    return `
<!DOCTYPE html>
<html>
<head>
